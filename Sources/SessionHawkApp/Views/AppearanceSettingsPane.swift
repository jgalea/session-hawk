...
struct AppearanceSettingsPane: View {
    ...
    private var centerLabelSection: some View {
        ...
        HStack(spacing: 12) {
            ...
            centerLabelCard(.sessionName,  sample: "session-hawk")
    ...
    private var previewLabel: String? {
        ...
        case (.running, .sessionName): return "session-hawk"
    ...
    private var previewSessionSections: [AppearanceSessionPreviewSection] {
        ...
        case .project:
            let groups = ["session-hawk", "website", "docs"]
    ...
    private var previewSessionItems: [AppearanceSessionPreviewItem] {
        [
            .init(
                ...
                agent: "Claude",
                agentShort: "claude",
                agentColor: Color(hex: AgentTool.claudeCode.brandColorHex) ?? Color(red: 0.55, green: 0.72, blue: 1.0),
                project: "session-hawk",
                branch: "v8-design",
            ...
            .init(
                ...
                agent: "Claude",
                agentShort: "claude",
                agentColor: Color(hex: AgentTool.claudeCode.brandColorHex) ?? Color(red: 0.62, green: 0.66, blue: 1.0),
                project: "website",
                branch: "main",
            ...
            .init(
                ...
                agent: "Claude",
                agentShort: "claude",
                agentColor: Color(hex: AgentTool.claudeCode.brandColorHex) ?? Color(red: 0.45, green: 0.78, blue: 1.0),
                project: "docs",
                branch: "main",
...
private struct StateIndicatorPreview: View {
    ...
    var body: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 8, style: .continuous)
                .fill(option == .tint ? Color(hex: AgentTool.claudeCode.brandColorHex)?.opacity(0.22) ?? Color.white.opacity(0.08) : Color.clear)
        )
    }

    @ViewBuilder
    private var indicator: some View {
        let color = Color(hex: AgentTool.claudeCode.brandColorHex) ?? V6Palette.paper
        switch option {
        case .animatedDot:
            Circle()
                .fill(color)
    ...
    var body: some View {
        HStack(spacing: 6) {
            if option == .compact {
                ...
                usageChip("Cx", window: "7d", value: 13, color: Color(hex: AgentTool.claudeCode.brandColorHex) ?? .blue)
            } else {
                RoundedRectangle(cornerRadius: 2, style: .continuous)
