...
public enum ManagedHooksBinary {
    public static let binaryName = "SessionHawkHooks"
    ...
    private static func installDirectory(fileManager: FileManager) -> URL {
        fileManager.homeDirectoryForCurrentUser
            ...
            .appendingPathComponent("SessionHawk", isDirectory: true)
...
public enum HooksBinaryLocator {
    public static func locate(
        ...
        if let explicitPath = environment["SESSION_HAWK_HOOKS_BINARY"] ?? environment["VIBE_ISLAND_HOOKS_BINARY"],
        ...
        let candidates = [
            executableDirectory?.appendingPathComponent("SessionHawkHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("SessionHawkHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("Helpers/SessionHawkHooks"),
            ...
            #endif
            return [
                currentDirectory.appendingPathComponent(".build/\(archTriple)/release/SessionHawkHooks"),
                currentDirectory.appendingPathComponent(".build/release/SessionHawkHooks"),
                ...
                currentDirectory.appendingPathComponent(".build/\(archTriple)/debug/SessionHawkHooks"),
                currentDirectory.appendingPathComponent(".build/debug/SessionHawkHooks"),
