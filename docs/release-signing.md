...
Session Hawk releases are code-signed and notarized via GitHub Actions. This document explains how to set up the required secrets.
...
2. Generate a new password, label it `session-hawk-notary`
...
```bash
export SESSION_HAWK_SIGN_IDENTITY="Developer ID Application: Your Name (TEAMID)"
export SESSION_HAWK_NOTARY_PROFILE="session-hawk-notary"
export SESSION_HAWK_VERSION="0.2.0"
