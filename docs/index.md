...
- [CONTRIBUTING.md](../CONTRIBUTING.md) for the repository workflow and contribution model
- [docs/roadmap.md](./roadmap.md) for the project roadmap and contribution focus areas
- [docs/product.md](./product.md) for the product scope and supported terminals
...
- [docs/releasing.md](./releasing.md) for the GitHub release workflow and checklist

## Hooks

- [docs/hooks.md](./hooks.md) for the Claude Code hook events, payload fields, and directive response protocol
...
- [docs/ssh-setup.md](./ssh-setup.md) for connecting Session Hawk to Claude Code running on remote servers via SSH socket forwarding
