...
- `AppIcon.appiconset/`, `SessionHawk.iconset/`, and `SessionHawk.icns` are generated packaging assets.
...
- the script outputs:
  ...
  - `SessionHawk.iconset/` and `SessionHawk.icns` for manual macOS bundle packaging
