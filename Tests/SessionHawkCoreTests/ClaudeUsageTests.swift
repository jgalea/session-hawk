...
struct ClaudeUsageTests {
    ...
    func claudeUsageLoaderParsesCachedRateLimits() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-usage-\(UUID().uuidString)", isDirectory: true)
        let cacheURL = rootURL.appendingPathComponent("session-hawk-rl.json")
    ...
    func claudeUsageLoaderParsesUtilizationPayloadWithISO8601ResetDates() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-usage-iso-\(UUID().uuidString)", isDirectory: true)
        let cacheURL = rootURL.appendingPathComponent("session-hawk-rl.json")
    ...
    func claudeUsageLoaderPrefersMostRecentLegacyOrCurrentCache() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-usage-candidates-\(UUID().uuidString)", isDirectory: true)
        let currentCacheURL = rootURL.appendingPathComponent("session-hawk-rl.json")
    ...
    func claudeStatusLineInstallationManagerInstallsManagedScriptWithoutOverwritingCustomCommand() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-status-\(UUID().uuidString)", isDirectory: true)
        let claudeDirectory = rootURL.appendingPathComponent(".claude", isDirectory: true)
        let scriptDirectory = rootURL
            .appendingPathComponent(".session-hawk", isDirectory: true)
    ...
    func claudeStatusLineInstallationManagerRepairsMissingLegacyManagedScript() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-repair-\(UUID().uuidString)", isDirectory: true)
        let claudeDirectory = rootURL.appendingPathComponent(".claude", isDirectory: true)
        let scriptDirectory = rootURL
            .appendingPathComponent(".session-hawk", isDirectory: true)
            .appendingPathComponent("bin", isDirectory: true)
    ...
    func claudeStatusLineInstallationManagerUninstallsBrokenManagedConfiguration() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-uninstall-broken-\(UUID().uuidString)", isDirectory: true)
        let claudeDirectory = rootURL.appendingPathComponent(".claude", isDirectory: true)
        let scriptDirectory = rootURL
            .appendingPathComponent(".session-hawk", isDirectory: true)
            .appendingPathComponent("bin", isDirectory: true)
    ...
    func claudeStatusLineInstallationManagerRejectsExistingCustomStatusLine() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-conflict-\(UUID().uuidString)", isDirectory: true)
        let claudeDirectory = rootURL.appendingPathComponent(".claude", isDirectory: true)
        let scriptDirectory = rootURL
            .appendingPathComponent(".session-hawk", isDirectory: true)
            .appendingPathComponent("bin", isDirectory: true)
    ...
    func claudeStatusLineInstallationManagerWrapsExistingCustomStatusLine() throws {
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-wrap-\(UUID().uuidString)", isDirectory: true)
        let claudeDirectory = rootURL.appendingPathComponent(".claude", isDirectory: true)
        let scriptDirectory = rootURL
            .appendingPathComponent(".session-hawk", isDirectory: true)
            .appendingPathComponent("bin", isDirectory: true)
        ...
        let savedOriginal = settingsAfterInstall[sessionHawkOriginalStatusLineKey] as? [String: Any]
        ...
        #expect(settingsAfterUninstall[sessionHawkOriginalStatusLineKey] == nil)
    ...
    func claudeStatusLineInstallAutoFallsBackToWrapperViaHandler() throws {
        ...
        let rootURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("session-hawk-claude-fallback-\(UUID().uuidString)", isDirectory: true)
        let claudeDirectory = rootURL.appendingPathComponent(".claude", isDirectory: true)
        let scriptDirectory = rootURL
            .appendingPathComponent(".session-hawk", isDirectory: true)
            .appendingPathComponent("bin", isDirectory: true)
