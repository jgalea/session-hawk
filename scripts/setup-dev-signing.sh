#!/bin/zsh
#
# Create a local self-signed code signing identity for Session Hawk dev
...
IDENTITY_NAME="Session Hawk Dev Local"
...
echo "you give Session Hawk Dev will persist across rebuilds."
