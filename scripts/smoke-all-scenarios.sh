...
base_dir="${SESSION_HAWK_HARNESS_ARTIFACT_DIR:-$repo_root/output/harness/smoke-all-$timestamp}"
...
for scenario in "${scenarios[@]}"; do
    ...
    SESSION_HAWK_HARNESS_SCENARIO="$scenario" \
    SESSION_HAWK_HARNESS_ARTIFACT_DIR="$scenario_dir" \
